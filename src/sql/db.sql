...
-- Schema test_obd_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `test_obd_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `mydb` ;
...
-- -----------------------------------------------------
-- Table `test_obd_db`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `test_obd_db`.`user` ;

CREATE TABLE IF NOT EXISTS `test_obd_db`.`user` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mydb`.`comment` (
  ...
  CONSTRAINT `comment_author`
    ...
    REFERENCES `test_obd_db`.`user` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
